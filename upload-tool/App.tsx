...
interface IEventsDetail {
  readonly events: Array<string>;
  readonly label: string;
}

function App() {
  if (window.location.href.indexOf("dexdev") > -1) {
        ...
        <div className="grid-container">
          ...
          <div className="grid-row flex-wrap flex-align-start">
            ...
            <div className="grid-col-4">
              ...
              <Dropdown
                id="event"
                label={events?.label || "Select Events"}
                srText="Select Event"
                items={events?.events || []}
                onSelect={(item) => {
                  dispatch({
          ...
          <input
            className="usa-input"
            id="meta_ext_objectkey"
            name="meta_ext_objectkey"
            onChange={(e) => {
              dispatch({
                type: "updateField",
                field: "meta_ext_objectkey",
                payload: e.target.value,
              });
            }}
          />
          <label className="usa-label" htmlFor="meta_ext_uploadid">
            meta_ext_uploadid
          </label>
          <input
            className="usa-input"
            id="meta_ext_uploadid"
            name="meta_ext_uploadid"
            onChange={(e) => {
              dispatch({
                type: "updateField",
                field: "meta_ext_uploadid",
                payload: e.target.value,
              });
            }}
          />
